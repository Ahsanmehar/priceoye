...
function FirstSection({ title, subtitle, description, img }) {
  return (
    <div className="w-[100%] px-28 max-xxxl:px-[80px] max-xxl:px-[60px] max-xl:px-[30px] max-l:px-[20px] max-3:px-[10px] flexbox max-xxl2:flex-col max-xxl2:items-start max-xxl2:gap-[50px] mt-[90px] mb-[90px] max-2:mb-[30px] max-l:mt-[40px]">
      <div className="w-[50%] max-xxl2:w-[85%] max-2:w-[100%] h-[100%] flex flex-col gap-[25px]">
        ...
        <h1 className="text-[56px] max-l:text-[41px] max-2:text-[25px] font-semibold text-myblack1">{subtitle}</h1>
