...
function CartPopUp() {
  ...
  let cartpopup = useSelector((state) => state.popup.cartpopup);
  let quikviewpopup = useSelector((state) => state.popup.quikviewpopup);
            ...
            return (
              ...
              >
                ...
                <div class="w-3/4 h-full">
                  ...
                  <h4 class="text-base text-[#181d25] mb-4">{data.newPrice}</h4>
                  <div class="w-[98px] h-[34px] border border-myblue rounded-full flex items-center justify-between overflow-hidden">
                    <i class="ri-subtract-line w-8 h-8 flex items-center justify-center cursor-pointer text-myblue text-xs font-semibold hover:bg-gray-200"></i>
                    <span class="text-gray-600 text-sm">0</span>
                    <i class="ri-add-line w-8 h-8 flex items-center justify-center cursor-pointer text-myblue text-xs font-semibold hover:bg-gray-200"></i>
                  </div>
                </div>
                <div class="mt-5">
                  <i class="ri-close-large-line text-myblue cursor-pointer text-lg font-medium"></i>
                </div>
              </div>
            );
          })}
