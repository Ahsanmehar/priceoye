function HaveAQuestion() {
  return (
    <div className="w-100% my-[80px] max-2:my-[60px] px-28 max-xxxl:px-[80px] max-xxl:px-[60px] max-xl:px-[30px] flexbox max-xxl2:flex-col max-xxl2:items-start max-xxl2:gap-[50px]">
      <div className="w-[44%] max-xxl2:w-[85%] max-2:w-[100%] h-[100%] flex flex-col gap-[20px]">
        <h5 className="text-[15px] font-medium text-myblue">
          HAVE A QUESTIONS
        </h5>
        <h1 className="text-[46px] max-l:text-[35px] max-2:text-[25px] font-semibold">
          Leave Us A Message?
        </h1>
        ...
        <form className="flex flex-col gap-[20px] max-2:gap-[12px]">
          ...
          <textarea
            ...
            rows={4}
          ></textarea>
          <button className="w-fit bg-myblue py-[15px] max-2:px-[30px] px-[50px] max-l:px-[30px] rounded-[10px] text-white max-2:text-[14px]">
            SEND MESSAGE
          </button>
        </form>
      </div>
