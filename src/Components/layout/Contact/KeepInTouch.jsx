function KeepInTouch() {
  return (
    <div className="w-[100%] px-28 max-xxxl:px-[80px] max-xxl:px-[60px] max-xl:px-[30px] flexbox max-xxl2:flex-col max-xxl2:items-start max-xxl2:gap-[50px]">
      <div className="w-[45%] max-xxl2:w-[100%] h-[550px]">
        <img
      ...
      <div className="w-[50%] max-xxl2:w-[85%] h-[100%] flex flex-col gap-[15px]">
        ...
        <h1 className="text-[46px] max-l:text-[33px] font-semibold">
        ...
        <div className="flex flex-col gap-[25px] mt-[35px]">
          <div className="flex gap-[15px]">
            ...
            <div>
              <h2 className="text-[24px] font-medium">Email</h2>
              <h5 className="text-[16px] text-myblack">
          ...
          <div className="flex gap-[15px]">
            <div className="w-[45px] h-[45px] bg-myblue rounded-[50%] flexcenter">
              <i className="bi bi-telephone text-[20px] text-white"></i>
            </div>
            <div>
              <h2 className="text-[24px] font-medium">Phone Number</h2>
              <h5 className="text-[16px] text-myblack">+92 309 7230656</h5>
            </div>
          </div>
          <div className="flex gap-[15px]">
            <div className="w-[45px] h-[45px] bg-myblue rounded-[50%] flexcenter">
            ...
            <div>
              <h2 className="text-[24px] font-medium">Location</h2>
              <h5 className="text-[16px] text-myblack">
