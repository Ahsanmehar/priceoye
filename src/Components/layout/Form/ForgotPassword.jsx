  ...
  return (
    <h1>
      <div className="w-[100%] h-[100vh] flex max-l4:flex-col">
        <div className="w-[35%] max-xxxl1:w-[40%] max-xxl2:w-[50%] max-l4:w-[100%] h-[100%] bg-pink-20 flex flex-col justify-between max-l4:gap-[40px] py-[30px] px-[90px] max-xxxl:px-[70px] max-xxl:px-[50px] max-xl:px-[25px]">
          ...
          <div className="flex flex-col gap-[10px] max-l4:hidden">
            ...
            <h6 className="text-[13px] text-myblack">
              © 2025
              <span className="text-myblack1 font-medium ">PriceOye</span>- All
              Rights Reserved.
            </h6>
          </div>
        </div>
